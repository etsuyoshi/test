...
- (void)postUsersEditPaymentWithSessionId:(NSString *)sessionId creditcartPayment:(int)creditcartPayment codPayment:(int)codPayment charge:(int)charge btPayment:(int)btPayment bankName:(NSString *)bankName branchName:(NSString *)branchName accountType:(NSString *)accountType accountName:(NSString *)accountName accountNumber:(NSString *)accountNumber completion:(void (^)(NSDictionary *results, NSError *error))block;
